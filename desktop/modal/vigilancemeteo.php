...
$vigilancemeteo = vigilancemeteo::byId(init('id'));
...
<iframe src="<?php echo $vigilancemeteo->getLink(); ?>" height="100%" width="100%">You need a Frames Capable browser to view this content.</iframe>
